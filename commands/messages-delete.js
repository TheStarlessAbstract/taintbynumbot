...
let versions = [
	...
	{
		description:
			"Searches for a message that contains this string, returns the index number of the message, or message if multiple. Use above version to delete specific message",
		usage: "!delMessage sit on my face",
		usableBy: "mods",
		active: true,
	},
];
